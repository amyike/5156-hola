...
public class Page<T> {
	...
	public Page(int pageIndex, int pageSize, int total, String url,
			int viewedNum) {
		init(pageIndex, pageSize, total, url, viewedNum);
	}
	...
	public String createPageBar(String url, int viewedNum,
	...
	public String createPageBar(String url, int viewedNum, String params) {
		if (pageNumber <= 1)
			return "";
		if (params == null)
			params = "";
	...
	public Page<T> setParams(Map<String, String> params) {
		this.params = params;
		return this;
	}
	...
	public static void main(String[] args) {
		Page<Object> page = new Page<Object>(2, 50, 51, "", 5);
