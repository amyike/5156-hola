...
public abstract class Constants {
	...
	public final static String DURL = "http://www.kaliry.cn/";

	// 发送邮件服务、用户名和密码
	public final static String MAILNAME = "info@kaliry.cn"; // 发送邮件的邮箱账号
	public final static String MAILPWD = "123456"; // 发送邮件的邮箱密码
	public final static String HOST = "mail.kaliry.cn"; // 邮箱服务器域名或地址
}
