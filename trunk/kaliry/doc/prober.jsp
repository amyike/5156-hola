...
<body background="image/mainfreambeijing.jpg">
	<table align="center" width="277" border="0">
		<tr>
			...
			<td width="85" align="center"><a
				href="http://hi.baidu.com/%D3%C7%D3%F4%B5%C4%BA%DA%D3%A5">个人博客</a></td>
			<td width="88" align="center"><a
				href="http://www.sdhacks.com.cn">小组网址</a></td>
		</tr>
	</table>
	<br>
	<table width="<%=tblWidth%>" align="<%=tblAlign%>" border="0"
		...
		<tr>
			<td colspan="2" height="22" bgcolor="#E0E0E0"><span></span></td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td>&nbsp;<%=request.getServerName()%> <%=getIp()%>
			</td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td>&nbsp;<%=application.getRealPath(request.getRequestURI())%>
			</td>
		</tr>
	</table>
	...
	<table width="<%=tblWidth%>" align="<%=tblAlign%>" border="0"
		cellspacing="0" cellpadding="1">
		<tr>
			<td colspan="2" height="22" bgcolor="#E0E0E0"><span>相关信息</span></span>
			</td>
		</tr>
		<tr>
	...
	<table width="<%=tblWidth%>" align="<%=tblAlign%>" border="0"
		cellspacing="0" cellpadding="1">
		<tr>
			<td colspan="2" height="22" bgcolor="#E0E0E0">&nbsp;服务器环境变量
				&nbsp;</td>
		</tr>
		<tr>
