...
<body>
	<table border="1" width="100%" summary="123">
		<tr class="main_title">
			<td height="30" align="center" style="font-size:16pt" colspan="10">招聘信息管理</td>
		</tr>
		<tr bgcolor="#FFFFFF" align="left" style="font-size:14px; height: 22pt;">
			<td colspan="10">
				<a href="javascript:void(0);" onclick="location.href='/job/add';return false;">添加</a>&nbsp;
				<a href="javascript:void(0);" onclick="location.href='/job/list';return false;">全部</a>&nbsp;
			</td>
		</tr>
	...
	<#list page.elements as job>
		<tr bgcolor="#FFFFFF" align="center">
			<td width="10%">${job.title!}</td>
			<td width="30%"><#if job.content??&&job.content?length gte 50>${job.content[0..50]}...<#else>${job.content!}</#if></td>
			<td>${job.time?string("yyyy-MM-dd HH:mm:ss")}</td>
			<td class="operate_a">
				<a href="javascript:void(0);" onclick="window.open('/job/${job.id!0}').focus();">查看</a>
				<a href="javascript:void(0);" onclick="if(confirm('确认要删除此信息？')){location.href='/job/del?id=${job.id!0}';return false;}">删除</a>
			</td>
		</tr>
	</#list>
		<tr bgcolor="#EEEEEE" align="center">
