...
<body>
<form name="mainForm" action="/job/add" method="post" autocomplete = "off">
	<table border="0" width="800px;">
		<tr class="main_title">
			<td height="30" align="center" style="font-size:16px" colspan="3">添加招聘信息</td>
		</tr>
		...
		<tr bgcolor="#EEEEEE" align="center">
			...
			<td>
				<textarea id="content" name="content" style="width:700px;height:300px;" msg="招聘信息内容">
					招聘信息内容
				</textarea>
			</td>
		</tr>
