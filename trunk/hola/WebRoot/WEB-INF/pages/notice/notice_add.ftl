...
<body>
<form name="mainForm" action="/notice/add" method="post" autocomplete = "off">
	<table border="0" width="800px;">
		<tr class="main_title">
			<td height="30" align="center" style="font-size:16px" colspan="3">添加公告信息</td>
		</tr>
		...
		<tr bgcolor="#EEEEEE" align="center">
			...
			<td>
				<textarea id="content" name="content" style="width:700px;height:300px;" msg="公告内容">
					公告内容
				</textarea>
			</td>
		</tr>
