 ...
 <?php else : // this is displayed if there are no comments so far ?>
	...
	<div id="comment-author-info">
		...
		<p>
			...
			<label for="email">邮箱<?php if ($req) echo " *"; ?> <a id="Get_Gravatar"  title="查看如何申请一个自己的Gravatar全球通用头像" target="_blank" href="http://www.itkes.com/teach-you-to-play-with-gravatar-world-wide-head">（教你设置自己的个性头像）</a></label>
		</p>
		<p>
